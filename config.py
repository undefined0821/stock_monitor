...
STOCK_SECTOR = {
    ...
    "600613": "医药卫生",   # 神奇制药(制药)
    "603220": "信息技术",   # 中贝通信(通信服务/AI算力)
    "605180": "原材料",     # 华生科技(BOPP电容薄膜/塑胶复合材料)
    "000779": "工业",       # 甘咨询(工程咨询/勘察设计, 非芯片)
    "001218": "原材料",     # 丽臣实业(表面活性剂/化学制品)
}
...
THEMES = [
    ...
    ("工程机械",   ["000157","600031","600528"]),
    ("基建/工程咨询", ["000779","603017","300284","300635"]),   # 甘咨询等工程咨询/勘察设计
]
...
THEME_KEYWORDS = [
    ...
    ("基建/工程咨询", ["工程咨询", "勘察设计", "设计院", "甘咨询", "中衡设计", "苏交科", "中达安"]),
]
